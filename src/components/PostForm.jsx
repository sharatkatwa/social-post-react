...
const PostForm = ({setAllPost, setShowPost}) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const handleData = (e) =>{
    console.log(e.image, e.description);
    setAllPost((prev)=>[...prev,{image:e.image, description:e.description}])
    setShowPost((prev)=>!prev)
  }
  return (
    <div className=" max-w-200 h-fit  rounded-xl shadow-2xl p-4 ">
